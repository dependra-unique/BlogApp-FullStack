            ...
            <nav className='navbar'>
                ...
                <div className='flex items-center gap-3 md:gap-6 ml-auto'>
...

                    {
                        ...
                        :
                        <>
                            <Link to="/signin" className='btn-dark py-2 px-4'>
                                Sign In
                            </Link>
                            <Link to="/signup" className='btn-light py-2 px-4 hidden md:block'>
                                Sign Up
                            </Link>
                        </>
                    }
...
//                                     {
//                                         userNavPanel ? <UserNavigationPanel closePanel={closeUserNavPanel} /> : ""
//                                     }
//                                 </div>
//                             </>
//                             :
